...
- [x] Main UI check such as following links and checking the display of information
- [x] Page title test
- [x] Page console test
...
## <img src="images/logo/Jenkins.svg" width="25" height="25"  alt="Jenkins"/></a> Jenkins <a target="_blank" href="https://jenkins.autotests.cloud/job/AUTO-797/"> job </a>
...
### :pushpin: Main page of <a target="_blank" href="https://jenkins.autotests.cloud/job/AUTO-797/3/allure/">Allure-report</a>
